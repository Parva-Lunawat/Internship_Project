import { Controller, Get, Delete, UseGuards, Req, Body, Param, Query, Res, Patch } from '@nestjs/common';
...
export class UsersController {
    ...
    @ApiOperation({
        ...
        description: 'Admin-ready endpoint to list users with filters and pagination',
    })
    ...
    async getAllUsers(@Req() req: { user: CurrentUser }, @Query() queryDto: QueryUsersDto) {
