  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <h4 className="mt-1 line-clamp-2 text-sm font-semibold leading-snug">{post.title}</h4>
        <p className="mt-1 line-clamp-2 text-xs text-gray-600 dark:text-gray-300">{post.excerpt}</p>
