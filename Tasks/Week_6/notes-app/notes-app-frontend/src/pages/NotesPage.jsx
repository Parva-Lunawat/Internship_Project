...
import { selectSortedNotes } from "../Redux/selector-functions/noteSelector";
...
export default function NotesPage() {
    ...
    // }, [dispatch]);
    useEffect(() => {
        // This now handles both the initial load AND the search filtering
        dispatch(showInitNotes(searchQuery));
    }, [searchQuery, dispatch]);
    // Add (notes || []) to ensure .find() never hits undefined
    ...
    //         // Fetch from backend with the search query
    //         const data = await listNotes(searchQuery);
    //         // Update Redux so the 'notes' state changes
    //         dispatch(showInitNotes(data));
    //     };

    //     // Optional: add a small debounce here so you don't hit the API on every keystroke
    //     fetchFiltered();
    // }, [searchQuery, dispatch]);

    // In this case, 'filteredNotes' is simply your notes from Redux
