// import { noteTitleContext } from '../pages/NotesPage'
// import { useContext } from 'react';

export default function Modal({ open, title, children, onClose }) {
    if (!open) return null;
    // const user = useContext(noteTitleContext);
    return (
            ...
            <div className="absolute left-4/100 -top-23/100 bottom-0 right-0 flex items-center justify-between p-5">
                <div className="w-full max-w-xl rounded-2xl bg-white shadow-xl">
                    <div className="flex items-center justify-between px-5 py-3 border-b-5">
                        {/* <h2 className="text-lg font-semibold text-zinc-900">{user !== null ? user : title}</h2> */}
